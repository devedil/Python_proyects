#Codido realizado por: Edilson Camacaro
#User github: DEVEDIL

#un Pequeno Juego de batalla pokemos realizado con python. espero les guste ;) 
...
def delay_print(s):
    # Funcion que Imprime un caracter a la vez
...
class Pokemon:
    def __init__(self, name, types, moves, EVs, health='==================='):
        # Guardando variables y atributos
        self.name = name
        self.types = types
        self.moves = moves
        ...
        self.health = health
        self.bars = 20 # Barra de vida


    def fight(self, Pokemon2):
        # Permitir que dos Pokemon luchen entre si.

        # imprimiendo ataques y defensas
        ...
        while (self.bars > 0) and (Pokemon2.bars > 0):
            ...
            # Anade barras traseras y mejora la defensa.
            ...
            # Comprueba si Pokemon se desmaye
            if Pokemon2.bars <= 0:
            ...
            # Anadir barras traseras y mejora la defensa.
...
if __name__ == '__main__':
    ...
    Charizard.fight(Blastoise) # pelea